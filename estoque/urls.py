...
urlpatterns = [
    ...
    path(
        ...
        views.transportadora_create,
        name="transportadora_create",
    ),
    path(
        "transportadoras/<int:pk>/detalhes/",
        views.transportadora_detail,
        name="transportadora_detail",
    ),
    path(
        "transportadoras/<int:pk>/editar/",
        views.transportadora_update,
        name="transportadora_update",
    ),
    path(
        "transportadoras/<int:pk>/deletar/",
        views.transportadora_delete,
        name="transportadora_delete",
    ),
]
